...
| --- | --- | --- |
| Full harness suite | `bun run test` (in `packages/harness`) | 1193 tests: unit + CLI + eval lanes (deterministic, guards, verification) + ratchet + goldens |
...
- Cost cap US$ 10/round; exit codes 0 pass · 1 fail/fail-infra · 2 cost cap.

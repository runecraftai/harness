...
description: >
  Discovers and invokes the right @runecraft/spells skill for the current task.
  Use when starting a session, when a request is ambiguous about which workflow to apply,
  or when you need to pick among the 13-skill Arcanum catalog.
  ...
  standalone tasks outside the Arcanum catalog, or runtime-specific configuration (e.g.,

...
describe("EVAL-MATRIX — consistência matriz ↔ testes (D9)", () => {
  test("matriz existe e declara MATRIX_VERSION + os EVAL-IDs da camada 2", () => {
    ...
    expect(matrix).toMatch(/MATRIX_VERSION:\s*8/);
    for (const id of ["EVAL-001", "EVAL-002", "EVAL-004", "EVAL-005", "EVAL-005b", "EVAL-006", "EVAL-007", "EVAL-008", "EVAL-009", "EVAL-010", "EVAL-011", "EVAL-012", "EVAL-013", "EVAL-014", "EVAL-015", "EVAL-016", "EVAL-017", "EVAL-018", "EVAL-019", "EVAL-020", "EVAL-021", "EVAL-022", "EVAL-023", "EVAL-024", "EVAL-025", "EVAL-026", "EVAL-027", "EVAL-028", "EVAL-029", "EVAL-030", "EVAL-031", "EVAL-032", "EVAL-033", "EVAL-034", "EVAL-035", "EVAL-036", "EVAL-037", "EVAL-038", "EVAL-039", "EVAL-040", "EVAL-041", "EVAL-042", "EVAL-043", "EVAL-044", "EVAL-045", "EVAL-046", "EVAL-047", "EVAL-048"]) {
  ...
  test("todo EVAL-<n> da matriz tem teste de fluxo na camada 2 que o referencia", () => {
    ...
    expect(matrixIds.size).toBeGreaterThanOrEqual(48); // EVAL-001..048 (EVAL-003 fora)

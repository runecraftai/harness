...
export function helpText(): string {
  ...
  return [
    ...
    "  --dry-run          Mostra o plano sem aplicar nenhuma mudança (install, sync)",
    "  --json             Saída JSON para CI (installed/kept/conflicts/failed | checks | packages)",
    "  --scope <escopo>   global | workspace (default: global; status/sync/uninstall usam workspace se houver state.json no projeto)",

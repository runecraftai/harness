...
export function helpText(): string {
  ...
  return [
    ...
    "  memory         Memória persistente (F29): search | stats | doctor [--purge] | import-lessons",
    "  models         Roteamento de modelo (F30): generate | list | doctor",
    "  sdd            Assets SDD (F30): new <feature> [--scope quick|medium|large] | chains",
    "  plans          Planos (F30): archive <slug>",
    "",
    "Flags:",
